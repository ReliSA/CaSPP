...
\begin{titlepage}
    ...
    \begin{flushleft}
        ...
        Osobní čísla: A25N0040P, A25N0052P (asi dodat ostatní) \\
        Emaily: qhdt@students.zcu.cz, bmilota@students.zcu.cz (asi další emaily) \\
        Datum: 16. 5. 2026
    \end{flushleft}
\end{titlepage}
...
\begin{figure}[H]
    \centering
    \adjustbox{max width=\textwidth,max height=0.85\textheight,center}{\includegraphics{images/dependency_diagram.pdf}}
...
\begin{figure}[H]
    \centering
    \adjustbox{max width=\textwidth,max height=0.85\textheight,center}{\includegraphics{images/dataflow_git.pdf}}
...
\begin{figure}[H]
    \centering
    \adjustbox{max width=\textwidth,max height=0.85\textheight,center}{\includegraphics{images/dataflow_display.pdf}}
...
\begin{figure}[H]
    \centering
    \adjustbox{max width=\textwidth,max height=0.85\textheight,center}{\includegraphics{images/dataflow_analysis.pdf}}
...
\begin{itemize}
    ...
    \item \textbf{\texttt{analyzer}} -- DOPLNIT
